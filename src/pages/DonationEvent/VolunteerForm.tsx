...
function VolunteerForm({ setActiveTab }: VolunteerFormProps) {
  ...
  return (
    <div className="w-full">
      {warning.length > 0 && <AlertBanner warning={warning} />}
      <Form {...form}>
        <form
        ...
        >
                ...
                <div className="flex-1">
                  <Popover>
                    <PopoverTrigger asChild>
                      <FormControl>
                        <Button variant={"outline"} className="w-full shadow-sm font-semibold">
                  ...
                  <FormItem className="">
                    ...
                    <div className="flex-1">
                      <Popover>
                        <PopoverTrigger asChild>
                          <FormControl>
                            <Button variant={"outline"} className="w-full md:min-w-[250px] shadow-sm font-semibold">
                              {field.value ? format(field.value, "PPP", { locale: vi }) : <span>mm/dd/yyyy</span>}
                              <CalendarIcon className="ml-auto h-4 w-4 opacity-75" />
                            </Button>
                          </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col md:flex-row gap-5 mb-10">
                <FormLabel className="text-[16px] w-[150px]">Nhóm máu</FormLabel>
                <div className="flex-1">
                  <FormControl>
                    <select
                      {...field}
                      className="py-2 text-sm md:text-base w-full bg-[#F4F5F8] h-10 md:h-[40px] border border-gray-200 rounded-lg"
                    >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col md:flex-row gap-5 mb-10">
                <FormLabel className="text-[16px] w-[150px]">Rh</FormLabel>
                <div className="flex-1">
                  <FormControl>
                    <select
                      {...field}
