...
function BloodAnalysisForm({ setIsAnalysisFormOpen, donor, fetchEvents }: BloodAnalysisProps) {
  ...
  const onSubmit = async (values: formType) => {
    const bloodTypeId =
      getTypeId(values.bloodType + values.rhFactor) > 0 ? getTypeId(values.bloodType + values.rhFactor) : 1;
    ...
    try {
      ...
      const response = await authenApi.post(
        `/api/blood-registrations/${donor.donationRegisId}/blood-procedures/qualify`,
        payload
      );
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Nhập tên người hiến" {...field} className="bg-white" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="number" placeholder="Vd: 250,300,350..." {...field} className="bg-white" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
