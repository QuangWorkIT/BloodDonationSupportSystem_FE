        ...
        <div className="flex flex-col md:flex-row justify-between items-start">
          <div className="space-y-1">
            ...
            <div className="flex gap-4 mt-1">
              ...
              <Link to="/policy" className="text-[#C9717A] hover:text-[#a83a42]">Chính sách</Link>
              <Link to="/blogs" className="text-[#C9717A] hover:text-[#a83a42]">Blog</Link>
              <Link to="/contact" className="text-[#C9717A] hover:text-[#a83a42]">Liên hệ</Link>
            </div>
          </div>
