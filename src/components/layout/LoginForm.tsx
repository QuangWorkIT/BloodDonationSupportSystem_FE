...
export default function LoginForm() {
  return (
    <div className="max-w-sm mx-auto mt-10 border rounded-lg shadow p-6 space-y-6 bg-white">
      ...
      <Button className="w-full bg-red-700 hover:bg-red-800">Đăng nhập</Button>
